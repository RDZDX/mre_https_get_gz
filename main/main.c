...
//char textppp[64];
//sprintf(textppp, "file_size=%u", file_size);
//log_text(textppp);
...
//                vm_ascii_to_ucs2(w_file_name1, (strlen(file_name) + 1) * 2, file_name);
                ...
                char final_name[128];
//                build_download_name(g_http_url.path, VM_FALSE, final_name, sizeof(final_name));
                build_download_name(g_http_url.path, http_is_gzip, final_name, sizeof(final_name));
                vm_ascii_to_ucs2(w_file_name1, (strlen(final_name) + 1) * 2, final_name);
...
//                sprintf(text, "Download successful, a total of %d bytes downloaded", file_size);
                ...
                sprintf(text, "Download successful, a total of %u bytes downloaded", total);
...
//vm_ascii_to_ucs2(old_name, sizeof(old_name),"e:\\https_download.bin");
